...
public class TextFileRepository<T extends Document> extends AbstractFileRepository<T> {

    protected DocumentConverter<T> converter;

    public TextFileRepository(String fileName, DocumentConverter<T> converter) {
        super(fileName);
